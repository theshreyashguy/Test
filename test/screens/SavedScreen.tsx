import { StatusBar, View, Text, Image, TouchableOpacity, TextInput, FlatList, Dimensions, Platform,KeyboardAvoidingView } from 'react-native'
  ...
  return (
    <View className="flex-1 relative bg-white">
      ...
      <SafeAreaView className={ios? '-mb-8': ''}>
        ...
        <View className="mx-4 flex-row mt-2 justify-between items-center">
